...
export const pt: Dictionary = {
  ...
  hero: {
    eyebrow: "ECOSSISTEMA GLOBAL DE REAL ESTATE",
    headlineDesktop: {
      line1: "O mercado imobiliário global,",
      line2: "impulsionado por Web2,",
      line3: "Web3 e Inteligência Artificial.",
    },
    headlineMobile: {
      line1: "O mercado imobiliário,",
      line2: "impulsionado por",
  ...
  vision: {
    ...
    quote:
      "“Não estamos construindo apenas mais uma plataforma imobiliária. Estamos conectando a infraestrutura de um mercado global.”",
    authorName: "GLEISSON OLIVEIRA HERIT",
    authorRole: "CRIADOR DO OPEN E DO PROJETO GLEMO",
  },
  market: {
    label: "03 — DADOS DE MERCADO",
    headlineLine1: "Um mercado de US$ 290T,",
    headlineLine2: "ainda amplamente desconectado.",
    descLine1:
    ...
    metrics: {
      ...
      companiesValue: "9MM+",
      companiesLabel: "EMPRESAS GLOBAIS\nMERCADO-ALVO",
      adoptionValue: "25%",
      adoptionLabel: "EMPRESAS NOS EUA\nADOÇÃO TECH",
      hubsValue: "EUA & DUBAI",
      hubsLabel: "PRINCIPAIS POLOS\nRWA & CRIPTO",
      aiValue: "MASSIVE AI",
      aiLabel: "CAMADA DE ADOÇÃO\nIA & WEB3",
    },
  },
  ecosystem: {
    ...
    steps: {
      ...
      step4Title: "Governança",
      step4Copy:
        "O marketplace introduz governança por meio do token gO.",
      step5Title: "Acesso",
      step5Copy:
        "Parceiros acessam aplicativos e ferramentas em todo o ecossistema.",
      step6Title: "Tokenizar",
      step6Copy:
        "A camada RWA expande incentivos e liquidez através do token gO.",
    },
  },
  products: {
    web2: {
      ...
      capabilityDetails: [
        ...
        "IA e dados para qualificar oportunidades em tempo real.",
        "Conectar parceiros e acelerar o fechamento de negócios.",
      ],
    },
    web3: {
      label: "06 — WEB3",
      ...
      capabilityDetails: [
        ...
        "Propriedade fracionada e liquidez global.",
        "Um mercado global com utilidade real e transparente.",
      ],
    },
  },
  marketplace: {
    ...
    explore: "Explorar",
    exploreApp: "Explorar aplicativo",
    ...
    apps: {
      ...
      presence: {
        ...
        subtitle: "Monitoramento de Mercado",
        description:
          "Acompanhe mercados, empreendimentos e oportunidades em tempo real.",
        features: ["Dados em tempo real", "Tendências de mercado", "Novas oportunidades"],
      },
      journey: {
  ...
  network: {
    ...
    signature: {
      ...
      line3: "UM AMANHÃ MAIS LÍQUIDO",
    },
    milestones: [
      "Mais de 80 parceiros ativos, incluindo nos Estados Unidos, Brasil e Dubai.",
      "Milhares de vendas intermediadas.",
      "Grandes incorporadoras brasileiras como clientes: MRV, BRZ, Rogga, Cyrela.",
    ],
  },
  roadmap: {
    eyebrow: "09 — ROADMAP",
    ...
    phases: {
      phase1: {
        year: "2026",
        items: [
          "Crescimento de parceiros (+2x)",
          "Marketplace de IA",
          "Imersão no mercado dos EUA",
          "Comunidade Web3",
        ],
      },
      phase2: {
      ...
      phase3: {
        year: "2028",
        items: [
          "Top of Mind para lançamentos imobiliários no Brasil",
          "Top of Mind em transações cross-border de novos imóveis",
          "Liderança na plataforma RWA",
        ],
      },
    },
  },
  closing: {
    leadership: {
      eyebrow: "10 — LIDERANÇA",
      titleMain: "Construído pela experiência.",
      titleHighlight: "Projetado para o que vem a seguir.",
      description:
        "Gleisson Herit é o fundador do glemO e especialista em projetos digitais desde 2001. Sua trajetória inclui mais de 20 anos na MRV e atuação com mais de 800 empresas.",
      ...
      facts: {
        ...
        expertiseLabel: "expertise digital",
      },
    ...
    events: {
      ...
      items: [
        ...
        { title: "Painel Global Blockchain Congress", detail: "Londres · Infraestrutura Web3 & RWA" },
        { title: "Time glemO no Web Summit Rio", detail: "2026 · Rio de Janeiro" },
        { title: "Demonstração glemO App", detail: "Londres · Global Blockchain Congress" },
        { title: "Networking no Web Summit Rio", detail: "2026 · Conexões e Parcerias" },
        { title: "Rodada de Negócios", detail: "Londres · Global Blockchain Congress" },
        { title: "glemO no GBC Londres", detail: "Presença & Conexões Internacionais" },
